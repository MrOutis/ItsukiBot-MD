...
conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${vid.title}.mp4`, mimetype: 'video/mp4', caption: `╭─⬣「 *YouTube Download* 」⬣\n│  ≡◦   *🍭 Título:* ${vid.title}\n│  ≡◦ *🪴 Calidad:* ${q}\n╰─⬣`, thumbnail: await fetch(vid.thumbnail) }, { quoted: m })
  } catch (error) {
}}
