...
conn.sendMessage(m.chat, {image: {url: haha}, caption: `🔞 Nsfw: *${command}*`.trim()}, {quoted: m});
}
...
conn.sendMessage(m.chat, {image: {url: res}, caption: `🔞 Nsfw: *${command}*`.trim()}, {quoted: m});
}
...
conn.sendMessage(m.chat, {image: {url: url}, caption: `🔞 Nsfw: *${command}*`.trim()}, {quoted: m});
}
